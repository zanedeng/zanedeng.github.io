...
var paper = new function(t) {
  ...
  "undefined" != typeof module && (module.exports = e), Array.isArray || (Array.isArray = function(t) {
    ...
    _set: function(n, i) {
      if (n && e.isPlainObject(n)) {
        ...
        for (var s in r)
          if (s in this && r.hasOwnProperty(s) && (!i || !i[s])) {
            var a = n[s];
            a !== t && (this[s] = a)
          }
        return !0
  ...
  var n = {
      ...
      fire: function(t, e) {
        ...
        if (!n) return !1;
        for (var i = [].slice.call(arguments, 1), r = this, s = 0, a = n.length; a > s; s++)
  ...
  var o = new function() {
    ...
    y = e.extend(n, {
      ...
      _initialize: function(t, e) {
        var n = t && t.internal === !0,
          ...
          r = paper.project;
        return n || (this._id = y._id = (y._id || 0) + 1), this._applyMatrix = this._canApplyMatrix && paper.settings.applyMatrix, e && i.translate(e), i._owner = this, this._style = new F(r._currentStyle, this, r), this._project || (n || t && t.insert === !1 ? this._setProject(r) : (r.activeLayer || new x).addChild(this)), t && t !== y.NO_INSERT ? this._set(t, {
          insert: !0
        }) : !0
      },
      ...
      isSelected: function() {
        if (this._selectChildren)
          for (var t = 0, e = this._children.length; e > t; t++)
            if (this._children[t].isSelected()) return !0;
        return this._selected
      },
      setSelected: function(t, e) {
        if (!e && this._selectChildren)
          for (var n = 0, i = this._children.length; i > n; n++) this._children[n].setSelected(t);
      ...
      isFullySelected: function() {
        if (this._children && this._selected) {
          for (var t = 0, e = this._children.length; e > t; t++)
            if (!this._children[t].isFullySelected()) return !1;
          return !0
        }
        return this._selected
      },
      setFullySelected: function(t) {
        if (this._children)
          for (var e = 0, n = this._children.length; n > e; e++) this._children[e].setFullySelected(t);
      ...
      hitTest: function(n, i) {
        ...
        var d, f, _ = !(i.guides && !this._guide || i.selected && !this._selected || (d = i.type) && ("string" == typeof d ? d !== e.hyphenate(this._class) : !(this instanceof d))),
          g = this;
        if (_ && (i.center || i.bounds) && this._parent) {
          var p = this.getInternalBounds();
          if (i.center && (f = r("center", "Center")), !f && i.bounds)
            for (var v = ["TopLeft", "TopRight", "BottomLeft", "BottomRight", "LeftCenter", "TopCenter", "RightCenter", "BottomCenter"], m = 0; 8 > m && !f; m++) f = r("bounds", v[m])
        }
        var y = !f && this._children;
        if (y)
          for (var w = this._getChildHitTestOptions(i), m = y.length - 1; m >= 0 && !f; m--) f = y[m].hitTest(n, w);
      ...
      draw: function(t, e) {
        if (this._visible && 0 !== this._opacity) {
          ...
          if (o.isInvertible()) {
            ...
            t.save(), p ? (t.globalAlpha = f, g && (t.globalCompositeOperation = d)) : t.translate(-u.x, -u.y), (p ? s : o).applyToContext(t), !p && e.clipItem && e.clipItem.draw(t, e.extend({
              clip: !0
            })), this._draw(t, e), t.restore(), i && r.pop(), e.clip && !e.dontFinish && t.clip(), p || (te.process(d, t, h, f, u.subtract(l).multiply(e.pixelRatio)), Q.release(t), e.offset = l)
          }
        }
      },
    ...
    C = y.extend({
      ...
      setSource: function(t) {
        ...
        var n, i = this;
        n = document.getElementById(t) || new Image, n.naturalWidth && n.naturalHeight ? setTimeout(e, 0) : (q.add(n, {
          load: e
    ...
    z = e.extend({
      ...
      statics: {
        ...
        getParameterOf: function(t, e, n) {
          ...
          for (var r, s, a = [], o = [], h = z.solveCubic(t, 0, e, a), u = z.solveCubic(t, 1, n, o), l = 0; - 1 == h || h > l;)
            if (-1 == h || (r = a[l++]) >= 0 && 1 >= r) {
              for (var c = 0; - 1 == u || u > c;)
    ...
    T = A.extend({
      ...
      function e(t, e, n) {
        function i(e) {
          var i = d[e];
          if (n) i._transformCoordinates(n, _, !1), r = _[0], s = _[1];
          else {
            var f = i._point;
            r = f._x, s = f._y
          }
      ...
      statics: {
        isClockwise: function(t) {
          for (var e = 0, n = 0, i = t.length; i > n; n++)
            for (var r = z.getValues(t[n], t[i > n + 1 ? n + 1 : 0]), s = 2; 8 > s; s += 2) e += (r[s - 2] - r[s]) * (r[s + 1] + r[s - 1]);
          return e > 0
        },
    ...
    getInteriorPoint: function() {
      ...
      if (!this.contains(e)) {
        for (var n = this._getMonoCurves(), i = [], r = e.y, s = [], a = 0, o = n.length; o > a; a++) {
          var h = n[a].values;
          if ((1 === n[a].winding && r >= h[1] && r <= h[7] || r >= h[7] && r <= h[1]) && z.solveCubic(h, 1, r, i, 0, 1) > 0)
            for (var u = i.length - 1; u >= 0; u--) s.push(z.evaluate(h, i[u], 0).x);
          if (s.length > 1) break
        }
        e.x = (s[0] + s[1]) / 2
      }
        ...
        initialize: function l(e) {
          ...
          if ("string" === d && e in i && (n = e, e = u[1], Array.isArray(e) ? (s = e, a = u[2]) : (this.__read && (c = 1), u = h.call(u, 1), d = typeof e)), !s) {
            if (o = "number" === d ? u : "object" === d && null != e.length ? e : null) {
              ...
              } else if (e.constructor === B) n = "gradient", o = u;
            else {
  ...
  var B = e.extend({
    ...
    F = e.extend(new function() {
      ...
      return e.each(n, function(n, a) {
        ...
        s[l] = function(e) {
          var n = this._owner,
            i = n && n._children;
          if (i && i.length > 0 && !(n instanceof O))
            for (var r = 0, s = i.length; s > r; r++) i[r]._style[l](e);
          else {
    ...
    V = new function() {
      ...
      return {
        ...
        set: function(e, n, i) {
          if ("string" != typeof n)
            for (var a in n) n.hasOwnProperty(a) && this.set(e, a, n[a]);
          else {
            if (!e || i === t) return e;
        ...
        setStyle: function(t, e, n) {
          ...
          else !/^-?[\d\.]+$/.test(n) || e in a || (n += "px"), t.style[e] = n;
          return t
        },
  ...
  q.requestAnimationFrame = new function() {
    ...
    var e, n = V.getPrefixed(window, "requestAnimationFrame"),
      i = !1,
      s = [],
      a = !0;
    return q.add(window, {
  ...
  var X = e.extend(n, {
      ...
      initialize: function ke(t) {
        this._id = ke._id = (ke._id || 0) + 1, this._type = t.type in this._types ? t.type : "options" in t ? "list" : "onClick" in t ? "button" : typeof t.value, this._meta = this._types[this._type] || {
          type: this._type
        };
        var n = this,
        ...
        this._dontFire = !0, this._input = V.create(this._meta.tag || "input", {
          ...
          "for": i
        })], "td", [this._input]]), e.each(t, function(t, e) {
          this[e] = t
  ...
  return new function() {
    ...
    function i(t) {
      ...
      function i(n, i) {
        for (var r = e(n.range[0]), a = e(n.range[1]), o = 0, h = s.length - 1; h >= 0; h--)
          if (r > s[h][0]) {
            o = h + 1;
            break
          }
        ...
        if (t) {
          for (var s in t)
            if ("range" !== s) {
              var a = t[s];
              if (Array.isArray(a))
                for (var o = 0, h = a.length; h > o; o++) r(a[o], t);
          ...
          switch (t && t.type) {
            ...
            case "AssignmentExpression":
              if (!e || !("ForStatement" === e.type || "BinaryExpression" === e.type && /^[=!<>]/.test(e.operator) || "MemberExpression" === e.type && e.computed))
    ...
    ! function(t, e) {
      ...
      function P(t) {
        ...
        for (var e = "";;) {
          ...
          if (92 === i) {
            ...
            if ("0" === r && (r = null), ++ve, r) Oe && n(ve - 2, "Octal literal in strict mode"), e += String.fromCharCode(parseInt(r, 8)), ve += r.length - 1;
            else switch (i) {
              case 110:
                e += "\n";
                break;
      ...
      function ae() {
        ...
        for (t.properties = [], I(); !D(gn);) {
          ...
          var r, s = {
            ...
            a = !1;
          if (D(wn) ? (s.value = J(!0), r = s.kind = "init") : ce.ecmaVersion >= 5 && "Identifier" === s.key.type && ("get" === s.key.name || "set" === s.key.name) ? (a = i = !0, r = s.kind = s.key.name, s.key = oe(), be !== pn && V(), s.value = he(L(), !1)) : V(), "Identifier" === s.key.type && (Oe || i))
      ...
      function he(t, e) {
        ...
        var r = Ae,
          s = Te;
        if (Ae = !0, Te = [], t.body = W(!0), Ae = r, Te = s, Oe || t.body.body.length && j(t.body.body[0]))
          for (var a = t.id ? -1 : 0; a < t.params.length; ++a) {
            var o = 0 > a ? t.id : t.params[a];
            if ((qn(o.name) || Zn(o.name)) && n(o.start, "Defining '" + o.name + "' in strict mode"), a >= 0)
      ...
      var ve, me, ye, we, xe, be, Ce, Se, Pe, ke, Me, ze, Ie, Ae, Te, Oe, Le = [],
        Ee = {
          type: "num"
        },
        Ne = {
    ...
    return h.inject(_), c.inject(_), D.inject(_), "complete" === document.readyState ? setTimeout(a) : q.add(window, {
      load: a
    }), {
      compile: i,
      execute: s,
