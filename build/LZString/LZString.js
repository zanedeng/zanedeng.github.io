(function () {
    ...
    function compress(str)
    {
        ...
        return uint8ToStr(str16ToUint8(str));
    }
     ...
     * @returns {Uint8Array}
     */
    function str16ToUint8(str)
    {
        str = str || "";var len=str.length*2;
        var buf=new Uint8Array(len);
        for (var j = 0; j < str.length; j++)
        {
            var icode = str.charCodeAt(j);
            var n=j*2;
            buf[n]=icode;
            buf[n+1]=(icode>>8)& 0xff;
        }
        return buf;
    }
    ...
    {
        if (!LZString.__baseReverseDic[alphabet])
        {
            LZString.__baseReverseDic[alphabet] = {};
            for (var i = 0; i < alphabet.length; i++)
            {
                LZString.__baseReverseDic[alphabet][alphabet.charAt(i)] = i;
            }
        }
        return LZString.__baseReverseDic[alphabet][character];
    };
    ...
    LZString.compressToBase64 = function (input)
    {
        if (input == null)
            return "";
        var res = LZString._compress(input, 6, function (a) { return LZString.__keyStrBase64.charAt(a); });
        switch (res.length % 4) {
    ...
    LZString.decompressFromBase64 = function (input)
    {
        ...
        {
            return LZString.getBaseValue(LZString.__keyStrBase64, input.charAt(index));
        });
    };
    ...
    LZString.decompressFromUint8Array = function (compressed)
    {
        ...
        {
            return LZString.decompress(null);
        }
        else
        {
    ...
    LZString.compressToEncodedURIComponent = function (input)
    {
        if (input == null)
            return "";
        return LZString._compress(input, 6, function (a) { return LZString.__keyStrUriSafe.charAt(a); });
    };
    ...
    LZString.decompressFromEncodedURIComponent = function (input)
    {
        ...
        return LZString._decompress(input.length, 32, function (index)
        {
            return LZString.getBaseValue(LZString.__keyStrUriSafe, input.charAt(index));
        });
    };
    ...
    LZString.__keyStrBase64 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";
    LZString.__keyStrUriSafe = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+-$";
    LZString.__baseReverseDic = {};
    ...
    exports.str16ToUint8 = str16ToUint8;
